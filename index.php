...
<div class="row aboutus-container">
    <div class="container">
        <a href="<?php echo URL; ?>aboutus.php">
            ...
            <div class="aboutus-right">
                ...
                <a href="" class="aboutus-more">სრულად ნახვა</a>
                <div class="aboutus-bottom">
                    <img src="<?php echo URL; ?>public/img/pigs.png">
                </div>
            </div>
        </a>
    </div>
...
<div class="row region-container">
    <div class="container">
        <h2>რეგიონები</h2>
        <div class="region-items region-slick">
...
<div class="row news-container">
    <div class="container">
        ...
        <div class="news-wrapper">
            <div class="news-left">
                <a href="#">
                    <img src="<?php echo URL; ?>public/img/donkey.png">
                    <span class="news-date">11 დეკემბერი</span>
                    <h3>გავრცელებული მოსაზრებით, Lorem Ipsum შემთხვევითი ტექსტი სულაც არაა. მისი ფესვები ჯერკიდევ ჩვ. წ. აღ-მდე 45 წლის დროინდელი </h3>
                    <p>გავრცელებული მოსაზრებით, Lorem Ipsum შემთხვევითი ტექსტი სულაც არაა. მისი ფესვები ჯერკიდევ ჩვ. წ. აღ-მდე 45 წლის დროინდელი </p>
                    <span>...</span>
                </a>
            </div>
